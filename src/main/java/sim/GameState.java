...
public class GameState {
    /*
    TODO figure out if we want a nested set of Objects where the collection of the largest Object is in GameState:
        List<World> worlds[
            World:
                List<Pop> pops[
                    Pop,
    ...
    or if it would be better to store all collections at the GameState level like so:
    List<World> worlds[
        World,
        World,
        World
    ...
    TODO additionally we want to ask if our collections:
        hold Objects [World, World, World]
        or hold id's [0, 1, 2] that correspond to objects
    */
